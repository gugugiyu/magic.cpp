...
<div class="space-y-6">
	...
	<div class="flex gap-2 border-t border-border/30 pt-6">
	...
	<div class="space-y-3 border-t border-border/30 pt-6">
							...
							<div class="space-y-2 border-t border-border/20 bg-muted/20 px-3 py-2.5">
								...
								<label class="flex cursor-pointer items-center gap-2">
									<input
										...
										onchange={(e) =>
											modelCapabilityStore.setToolCalling(modelId, e.currentTarget.checked)}
									/>
								...
								>
									<input
										...
										onchange={(e) =>
											modelCapabilityStore.setVision(modelId, e.currentTarget.checked)}
									/>
									<span class="text-xs">
								...
								>
									<input
										...
										onchange={(e) =>
											modelCapabilityStore.setAudio(modelId, e.currentTarget.checked)}
									/>
									<span class="text-xs">
