<script lang="ts">
	...
	let { class: className = '', message = 'Initializing connection to magic.cpp server...' }: Props =
		$props();
</script>
...
<div class="flex h-full items-center justify-center {className}">
	<div class="text-center">
		<div class="mb-4" in:fade={{ duration: 300 }}>
			<div class="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-info-bg">
				<Server class="h-8 w-8 animate-pulse text-info" />
			</div>
